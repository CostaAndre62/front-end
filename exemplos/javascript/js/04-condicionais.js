...
// Determinando casas decimais com toFixed
...
/* Algoritmo:
Se a média for menor que 3, então desempenho será péssimo. Senão, se for menor que 5, ruim. Senão, se menor que 7, então regular. Senão, se menor que 9, então bom. Senão, ótimo. */
...
switch(opcao){
    ...
    default: mensagem = "Não entendi... vou transferir."; break;
}
